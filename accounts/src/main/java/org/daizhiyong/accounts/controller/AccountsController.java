package org.daizhiyong.accounts.controller;
...
@Tag(
        name = "CRUD REST APIs for Accounts in CCBANK 新新银行",
...
public class AccountsController {
    ...
    public String sayHello(){
        // TODO: change this to a i18n message
        return "Hello World.";
    }

    @Operation(
            summary = "Create Account REST API",
            description = "REST API 生成新的Customer和账号在银行里"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
                    description = "HTTP Status 生产"
            ),
            @ApiResponse(
                    responseCode = "500",
