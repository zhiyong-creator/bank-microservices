package org.daizhiyong.loans.constants;
...
public final class LoansConstants {
    ...
    public static final String  MESSAGE_417_UPDATE= "更新操作失败。 请稍后再试或联系服务团队。";
    //public static final String  MESSAGE_417_DELETE= "Delete operation failed. Please try again or contact Dev team";
    public static final String  MESSAGE_417_DELETE= "删除操作失败。 请稍后再试或联系服务团队。";
